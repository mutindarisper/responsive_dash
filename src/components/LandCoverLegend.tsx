...
const LandCoverLegend = () => {
    ...
    const categories: string[] = ['Forests', 'Cropland', 'Grassland','Built-up', 'Shrubland','Wetland','Bareland','Water'];
            ...
            <TabContext value={value} >
                ...
                <TabPanel value="1" style={{ fontFamily: 'Poppins', fontWeight: 700 }}>
                {
                            categories.map((item) => (
                                <div className="d-flex gap-2 ">
                                    <div style={{
                                        backgroundColor: item === 'Forests' ?
                                            '#417843' : item === 'Cropland' ? '#F4B1E6' :
                                                item === 'Grassland' ? '#B1D396' :
                                                    item === 'Built-up' ? '#E92525' :item === 'Shrubland' ?
                                                        '#6C8366': item === 'Wetland' ? '#79A6B5' 
                                                        : item === 'Bareland' ? '#C7C7C7' : '#0D509F'
                                        ,
                ...
                <TabPanel value="2" style={{ fontFamily: 'Poppins', }}>
                    ...
                    <List >
                        ...
                        <p style={{fontWeight:700}}>Land Use for AOI</p>
                        <p>In 2010, AOI had 13.2 Mha of natural forest, extending over 70% of its land area. </p>

                        <GainBarChart data={data} labels={labels}  />

                        <Divider variant="middle" component="li" style={{ marginBottom: '1em' }} />
                        <p style={{fontWeight:700}}>Cropland in AOI</p>
